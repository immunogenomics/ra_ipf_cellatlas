plot_box <- function(dat, title = "") {
  ...
  clusters <- c( "AT1", "AT2",  "AT2 a", "AT2 b", "B",  "C1", "C2", "C3", "E1", "E2", "E3",
                 "F0", "F1", "F2", "F3", "F4", "F5",  "F6","F7", "F8",
                 "M0", "M1", "M2", "M3", "M4", "M5", "M6",  "M7", "M8", "M9", "M10",  "M11",  "M12",  "M14", "M15",
  ...
  p2 <- ggplot() +
    geom_col(
      ...
      color = "black", size = 0.12, width = 0.7
      # fill = "grey60"
    ) +
    geom_vline(
      data = data.frame(x = c(12.5, 27.5, 36.5, 39.5, 42.5, 43.5)),
